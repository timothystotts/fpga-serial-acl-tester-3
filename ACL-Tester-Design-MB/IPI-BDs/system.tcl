...
proc create_root_design { parentCell } {
  ...
  set led47 [ create_bd_port -dir O -from 0 -to 0 led47 ]
  ...
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins MuxSSD_0/ext_mux_clk] [get_bd_pins PmodACL2_0/ext_spi_clk] [get_bd_pins PmodCLS_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins clk_wiz_0/clk_out4] [get_bd_pins rst_clk_wiz_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_aresetn [get_bd_pins MuxSSD_0/ext_mux_rst] [get_bd_pins rst_clk_wiz_0_50M/peripheral_aresetn]
