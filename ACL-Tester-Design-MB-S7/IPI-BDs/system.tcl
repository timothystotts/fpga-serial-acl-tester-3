...
proc write_mig_file_system_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {    <TargetFPGA>xc7s25-csga324/-1</TargetFPGA>}
   ...
   puts $mig_prj_file {            <Pin PADName="R2(MRCC_P)" Bank="34" name="sys_clk_i" />}
   puts $mig_prj_file {        </System_Clock>}
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.C_SSD_CLK_RATIO {810000} $MuxSSD_0
  ...
  set_property -dict [list \
    CONFIG.CLKIN1_JITTER_PS {123.07000000000001} \
    CONFIG.CLKOUT1_JITTER {224.835} \
    CONFIG.CLKOUT1_PHASE_ERROR {108.530} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {12.000} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {10.875} \
    CONFIG.MMCM_CLKIN1_PERIOD {12.308} \
    CONFIG.MMCM_CLKOUT0_DIVIDE_F {73.625} \
    CONFIG.MMCM_DIVCLK_DIVIDE {1} \
    CONFIG.PRIM_IN_FREQ {81.247969} \
  ] $clk_wiz_0
  ...
  connect_bd_intf_net -intf_net PmodACL2_0_Pmod_out [get_bd_intf_ports jb] [get_bd_intf_pins PmodACL2_0/Pmod_out]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins MuxSSD_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins PmodACL2_0/AXI_LITE_GPIO] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins PmodACL2_0/AXI_LITE_SPI] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins PmodCLS_0/AXI_LITE_SPI] [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M09_AXI [get_bd_intf_pins axi_gpio_1/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M09_AXI]
  ...
  connect_bd_net -net PmodACL2_0_GPIO_Interrupt [get_bd_pins PmodACL2_0/GPIO_Interrupt] [get_bd_pins microblaze_0_xlconcat/In2]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins PmodACL2_0/ext_spi_clk] [get_bd_pins PmodCLS_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins rst_clk_wiz_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins MuxSSD_0/ext_mux_clk] [get_bd_pins MuxSSD_0/s00_axi_aclk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/M09_ACLK] [get_bd_pins PmodACL2_0/s_axi_aclk] [get_bd_pins PmodCLS_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins rst_mig_7series_0_81M/slowest_sync_clk] [get_bd_pins axi_smc/aclk]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_clk_wiz_0_50M/ext_reset_in]
  connect_bd_net -net rst_mig_7series_0_81M_bus_struct_reset [get_bd_pins rst_mig_7series_0_81M/bus_struct_reset] [get_bd_pins microblaze_0_local_memory/SYS_Rst]
  connect_bd_net -net rst_mig_7series_0_81M_mb_reset [get_bd_pins rst_mig_7series_0_81M/mb_reset] [get_bd_pins microblaze_0/Reset] [get_bd_pins microblaze_0_axi_intc/processor_rst]
  connect_bd_net -net rst_mig_7series_0_81M_peripheral_aresetn [get_bd_pins rst_mig_7series_0_81M/peripheral_aresetn] [get_bd_pins MuxSSD_0/s00_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins PmodACL2_0/s_axi_aresetn] [get_bd_pins PmodCLS_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins axi_smc/aresetn]
  connect_bd_net -net rst_mig_7series_0_81M_peripheral_reset [get_bd_pins rst_mig_7series_0_81M/peripheral_reset] [get_bd_pins MuxSSD_0/ext_mux_rst]
